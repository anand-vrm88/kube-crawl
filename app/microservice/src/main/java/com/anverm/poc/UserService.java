...
public class UserService implements Service {
    ...
    private synchronized void greetHandler(ServerRequest req, ServerResponse res) {
        String name = System.getenv("NAME");
        String company = System.getenv("COMPANY");
        String greetText = System.getenv("GREET_TEXT");
        res.status(200).send(String.format("Hello %s! %s %s.", name, company, greetText));
    }
